...
# =====================================================
    ...
    ax.plot(anomalies["Order Date"], anomalies["Sales"], label="Weekly Sales")

    iso = anomalies[anomalies["Isolation"] == -1]
    ...
    ax2.set_title("Rolling Z-Score Detection")
    ax2.legend()
...
# =====================================================
    ...
    for segment in clusters["Demand Segment"].unique():
        data = clusters[clusters["Demand Segment"] == segment]
        ax.scatter(
        data["PCA1"],
        data["PCA2"],
        label=segment
